...
source library/memory_puzzle_library.sh
...
function assert_expectations() {
	...
	echo "$test_result | Expected : ${expected} | ${output}"

}


# Test function for generate_values
function test_generate_values() {
	local number_of_cells=$1

}


# Test cases for generate_values
function test_cases_generate_values() {
	test_case_heading "generate_values()"

	echo -e "\nTest Case : Valid Inputs (Even Numbers)"
	echo $SEPARATOR
	test_generate_values 4 4
	test_generate_values 6 6
}
